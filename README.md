...
|---|---|---|---|
| 📦  | <img style="margin: 10px" src="https://profilinator.rishav.dev/skills-assets/javascript-original.svg" alt="JavaScript" height="50" /><img style="margin: 10px" src="https://profilinator.rishav.dev/skills-assets/nodejs-original-wordmark.svg" alt="Node.js" height="50" />  | [elsaland/elsa](https://github.com/paolodavid/Master-Thesis-IBM-Chatbot-for-anamnesis) | ❄️ Elsa is a minimal, fast and secure runtime for JavaScript and TypeScript written in Go |
