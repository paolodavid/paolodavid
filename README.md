...
|---|---|---|---|
| 📦  | <img style="margin: 10px" src="https://profilinator.rishav.dev/skills-assets/javascript-original.svg" alt="JavaScript" height="50" /> <img style="margin: 10px" src="https://profilinator.rishav.dev/skills-assets/nodejs-original-wordmark.svg" alt="Node.js" height="50" />  | [Master-Thesis-IBM-Chatbot-for-anamnesis](https://github.com/paolodavid/Master-Thesis-IBM-Chatbot-for-anamnesis) | Creation of a IBM chatbot using IBM Cloud Watson API for Speect Text recognition, to solve a anamnesis problem. |
